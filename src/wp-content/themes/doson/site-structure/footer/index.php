                     ...
                     <ul class="list-inline footer-socials mt-4">
                         <li class="list-inline-item">
                             ...
                             <a href="<?php echo get_field('facebook','option'); ?>"
                                 target="<?php echo get_field('facebook','option'); ?>"><i
                         ...
                         <li class="list-inline-item">
                             ...
                             <a href="<?php echo get_field('instagram','option'); ?>"
                                 target="<?php echo get_field('instagram','option'); ?>"><i
                         ...
                         <li class="list-inline-item">
                             ...
                             <a href="<?php echo get_field('tiktok','option'); ?>"
                                 target="<?php echo get_field('tiktok','option'); ?>"><svg
                         ...
                         <li class="list-inline-item">
                             ...
                             <a href="<?php echo get_field('youtube','option'); ?>"
                                 target="<?php echo get_field('youtube','option'); ?>"><i
